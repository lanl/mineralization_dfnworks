...
library(gridExtra)
library(latex2exp)
setwd("~/GitLab/sa_for_chemistry/fixed_dfn/uncorr_sobol_indices_fixedDFN")
...
sim_num        = (sim_num-1) %% 8 + 1
output_var_idx = sim_num + 20

# Grab the final hetGP model:
models_loc = "~/GitLab/sa_for_chemistry/fixed_dfn/joint_emulation/ftcn_models"
...
taopoints_to_remove = c("calcite_flush_0_nondim", "calcite_flush_1_nondim", "calcite_flush_2_nondim",    
                        "calcite_flush_3_nondim", "calcite_flush_10_nondim",    "calcite_flush_11_nondim",  "calcite_flush_12_nondim",
                        "gypsum_flush_0_nondim", 
                        "gypsum_flush_1_nondim",   
                        "gypsum_flush_2_nondim",  "gypsum_flush_3_nondim",  
                        "gypsum_flush_4_nondim",     
                        "gypsum_flush_5_nondim", 
                        "gypsum_flush_6_nondim", 
                        "gypsum_flush_7_nondim",  "gypsum_flush_8_nondim", 
                        "gypsum_flush_9_nondim",     
                        "gypsum_flush_10_nondim",  "gypsum_flush_11_nondim", 
                        "gypsum_flush_12_nondim", "calcite_flush_10_nondim",    
                        "gypsum_flush_10_nondim",     "calcite_flush_11_nondim",    
                        "gypsum_flush_11_nondim",     "calcite_flush_12_nondim",   
                        "gypsum_flush_12_nondim")
