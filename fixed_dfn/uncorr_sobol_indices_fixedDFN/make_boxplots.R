...
g2 = ggplot(graph_data, aes(x = input_var, y = value, fill = output_var)) + geom_boxplot(lwd=0.25, outlier.size = 0.2,
  ...
  labs(fill=TeX("Nondim. Time [$y/\\tau$]"))#+ guides(fill="none")  
...
bootstrapped_seed              = bootstrapped_seed[which(bootstrapped_seed$value <=1),]
...
g4 = ggplot(graph_data, aes(x = factor(input_var, levels = c('Da_1_gypsum', 'Da_1_calcite',
  ...
  theme(plot.title = element_blank(),
        ...
        plot.margin = margin(0, 0, 0, 0, "cm"), 
        plot.caption = element_blank()) + 
  labs(fill="Timepoints")+ guides(fill="none")
...
g2 = g2 + scale_fill_manual(labels = TeX(c('flush_4' = r"($10^{-3}$)", 
                                           'flush_5' = r"($10^{-2}$)", 
                                           'flush_6' = r"($10^{-1}$)",
                                           'flush_7' = r"($10^{0}$)",
                                           'flush_8' = r"($10^{1}$)",
...
g4 = g4 + scale_fill_manual(labels = TeX(c('flush_4' = r"($10^{-3}$)", 
                                           'flush_5' = r"($10^{-2}$)", 
                                           'flush_6' = r"($10^{-1}$)",
                                           'flush_7' = r"($10^{0}$)",
                                           'flush_8' = r"($10^{1}$)",
