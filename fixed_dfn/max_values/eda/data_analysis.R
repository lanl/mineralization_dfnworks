...
library(reshape)
library(tidyverse)
setwd("~/GitLab/sa_for_chemistry/fixed_dfn/max_values/eda")

# Data location:
data_path = "~/GitLab/sa_for_chemistry/fixed_dfn/max_values/data"
...
pairs(norm_data[,c(input_vars_for_emulation_fctn, output_vars[1:2])])
pairs(norm_data[,c(input_vars_for_emulation_nonfctn, output_vars[1:2])])
