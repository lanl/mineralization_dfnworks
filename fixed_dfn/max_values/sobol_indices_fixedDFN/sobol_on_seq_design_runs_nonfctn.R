...
models_loc = "~/GitLab/sa_for_chemistry/fixed_dfn/max_values/joint_emulation/non_ftcn_models"
...
tuning_2 = c('gypsum_flush_0_nondim', "gypsum_flush_1_nondim", 'calcite_flush_8_nondim',
             'calcite_flush_9_nondim','calcite_flush_5_nondim',
...
tuning_4 = c('calcite_flush_2_nondim','calcite_flush_4_nondim',  
