...
library(ggExtra) 
library(rlang)
setwd("~/GitLab/sa_for_chemistry/fixed_dfn/calibration_verification")
...
#                         "gypsum_flush_0_nondim", "gypsum_flush_1_nondim",
#                         "gypsum_flush_2_nondim", "gypsum_flush_3_nondim")
# early_gypsum_points = c("gypsum_flush_0_nondim", "gypsum_flush_1_nondim",
#                         "gypsum_flush_2_nondim", "gypsum_flush_3_nondim", 
...
# Changing these with a fixed DFN
...
for(output_var_idx in output_vars){
  print(paste("Starting Cholesky Analysis for Functional variable:", new_names[output_var_idx]))
