...
## Date: August 2023
library(hetGP)
setwd("~/GitLab/sa_for_chemistry/variable_dfn_regulartime/joint_emulation")
...
norm_data[,input_vars_for_emulation_fctn[2:length(input_vars_for_emulation_fctn)]] = 
  log(norm_data[,input_vars_for_emulation_fctn[2:length(input_vars_for_emulation_fctn)]])
...
tuning_2 = c('calcite_flush_2', 'calcite_flush_3')
tuning_3 = c('gypsum_flush_3_nondim','gypsum_flush_4_nondim', 
             'calcite_flush_2_nondim',            
             "gypsum_flush_0")
tuning_4 = c("calcite_flush_0", "calcite_flush_1")
