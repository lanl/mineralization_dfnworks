...
## Date: August 2023
library(hetGP)
setwd("~/GitLab/sa_for_chemistry/variable_dfn/joint_emulation")
...
taopoints_to_remove = c("calcite_flush_0_nondim", "calcite_flush_1_nondim", 
                        ...
                        "gypsum_flush_10_nondim","calcite_flush_10_nondim", 
                        "calcite_flush_0","gypsum_flush_0","calcite_flush_1",
                        "gypsum_flush_1","calcite_flush_2","gypsum_flush_2",
                        "calcite_flush_3","gypsum_flush_3","calcite_flush_4",
                        "gypsum_flush_4","calcite_flush_5","gypsum_flush_5",
                        "calcite_flush_6","gypsum_flush_6","max_calcite","min_gypsum")
...
tuning_4 = c('calcite_flush_4_nondim')
