...
library(tidyverse)
library(latex2exp)
setwd("~/GitLab/sa_for_chemistry/variable_dfn/eda")

# Data location:
data_path = "~/GitLab/sa_for_chemistry/variable_dfn/data"
...
outputs_abrv    = c("flush_0", "flush_1",
                    ...
                    "flush_5", "flush_6", 
                    "flush_7", "flush_8", "flush_9", "flush_10")
calcite_outputs = c("calcite_flush_0_nondim",      "calcite_flush_1_nondim", 
                    "calcite_flush_2_nondim", "calcite_flush_3_nondim",
                    "calcite_flush_4_nondim",      "calcite_flush_5_nondim", 
                    "calcite_flush_6_nondim",    
                    "calcite_flush_7_nondim",     "calcite_flush_8_nondim",
